...
class HoverProvider {
    constructor(mcpClient) {
        this.taskDocumentation = new Map();
...
\`\`\`
    ...
    getStageDependencies(stageName) {
        const dependencies = {
